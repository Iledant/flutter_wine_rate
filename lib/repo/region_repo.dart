...
class RegionRepository {
  ...
  const RegionRepository({@required this.db});

  Future<PaginatedRegions> getPaginated(PaginatedParams params) async {
  ...
  Future<List<Region>> getFirstFive(String pattern) async {
  ...
  Future<void> remove(Region region) async {
